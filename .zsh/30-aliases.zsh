...
# system Update (Arch specific updater script)
alias update='$ZSH_MOD_DIR/120-update.sh cli'
alias updateG='$ZSH_MOD_DIR/120-update.sh gui'
alias update-dry='$ZSH_MOD_DIR/120-update.sh dry'
...
# for the laptop related settings (only sourced if Acer Predator driver exists)
[[ -d "/sys/module/linuwu_sense" ]] && source "${0:A:h}/100-setting.zsh"
